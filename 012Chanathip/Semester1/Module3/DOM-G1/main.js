...
// const htmlChildren=rootElement.childNodes //childNodes เอาทุกelementที่มีถึงแม้จะเป็นสิ่งว่างเปล่า
// console.log(htmlChildren)
// console.log(htmlChildren.length)
// //2.Only element types of children
// const htmlElementChildren=rootElement.children//children เอาแค่elementที่มีไม่เอาว่างเปล่า
// console.log(htmlElementChildren)
// // console.log(htmlElementChildren.length)

// //document.body document.head
// const bodyNode=document.body
// const divNode=bodyNode.children[1] //เอาelementตัวที่2ในnode body
// console.log(divNode) //id="App"
// console.log(divNode.getAttribute('id'))

// //query node by using getElementById()
// const divByIdNode=document.getElementById('App')//เอาแค่ตัวแรก เพราะไอดีไม่ควรซ้ำ
