function todoUserInterface() {
  ...
  function removeTodoItem(removeId) {//ลบdivของรายการTodo โดยรับค่าId
    const remove = document.getElementById(removeId)//หาตัวที่จะลบ
    const listTodoParent = document.getElementById('listTodo')//หาพ่อของตัวที่อยากลบ
    listTodoParent.removeChild(remove)//ลบลูกของพ่อออก นั่นก็คือลบremove
  }
